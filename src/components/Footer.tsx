      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 pb-8 border-b border-[var(--divider-color)]">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2 text-xs">
              <li>
                <a href="#feed" className="text-[var(--text-secondary)] hover:text-spicy-paprika transition-colors">
                  All Discussions
                </a>
              </li>
              <li>
                <a href="#meetups" className="text-[var(--text-secondary)] hover:text-spicy-paprika transition-colors">
                  Local Meetups 🇮🇳
                </a>
              </li>
              <li>
                <a href="#tags" className="text-[var(--text-secondary)] hover:text-spicy-paprika transition-colors">
                  Trending Tags
                </a>
              </li>
              <li>
                <a href="#leaderboard" className="text-[var(--text-secondary)] hover:text-spicy-paprika transition-colors">
                  Chai Leaderboard
                </a>
              </li>
            </ul>
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2 text-xs">
              <li>
                <a href="#conduct" className="text-[var(--text-secondary)] hover:text-stormy-teal transition-colors">
                  Code of Conduct
                </a>
              </li>
              <li>
                <a href="#terms" className="text-[var(--text-secondary)] hover:text-stormy-teal transition-colors">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="#privacy" className="text-[var(--text-secondary)] hover:text-stormy-teal transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#feedback" className="text-[var(--text-secondary)] hover:text-stormy-teal transition-colors">
                  Feedback Portal
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] text-dust-grey">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#github-repo" className="hover:text-[var(--foreground)] transition-colors">
              Repository
            </a>
          </div>
        </div>
