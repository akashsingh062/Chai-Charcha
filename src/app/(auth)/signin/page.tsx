...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 1. Client-Side validation via our Zod Schema
    ...
    try {
      // 2. Sign In via better-auth client SDK
      // better-auth email signin expects email. If identifier is email, pass as is.
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-[var(--background)] text-[var(--foreground)] px-4 overflow-hidden py-16 transition-colors duration-300">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-linear-to-b from-[#D97706]/15 to-transparent rounded-full filter blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-linear-to-t from-[#F59E0B]/10 to-transparent rounded-full filter blur-[120px] pointer-events-none" />
